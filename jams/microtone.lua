-- microtone.lua - microtonal pitch gliding
-- A melody that slowly bends between notes using fractional MIDI values
...
function init(jam)
    ...
    current = 60
    step = 0
    steps = 32      -- how many ticks to glide over

    destinations = {60, 62, 63.5, 65, 67, 68.5, 70, 72}
    dest_idx = 1

    print("microtone loaded")
end
