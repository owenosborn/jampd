...
function tick(jam)
    ...
    if jam.on(2, 1)  then jam.noteout(54, 85, 1/4) 
    
    -- ghost notes
    elseif jam.on(1/3)  and p(.1)  then jam.noteout(54, 50, 1/4) 
    elseif jam.on(1/4)  and p(.1)  then jam.noteout(54, 50, 1/4) end
    
    -- Kick on 1 and 3
    if jam.on(2) then jam.noteout(40, 90, 1/4)
    
    -- ghost notes
    elseif  jam.on(1/3)  and p(.1)  then jam.noteout(40, 50, 1/4) 
    elseif  jam.on(1/4)  and p(.6)  then jam.noteout(40, 50, 1/4) end
end
